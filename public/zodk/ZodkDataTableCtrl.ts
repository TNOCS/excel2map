module zodk {
    ...
    export interface IZodkDataTableViewScope extends ng.IScope {
        vm: ZodkDataTableCtrl;
    ...
    export class ZodkDataTableCtrl {
        ...
        constructor(
            private $scope: IZodkDataTableViewScope,
        ...
        public getRows(): Array<Array<TableField>> {
            var meta: Array<IPropertyType> = new Array<IPropertyType>(this.headers.length);
