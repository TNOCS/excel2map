module Translations {
    export class DutchAdditional {
        public static locale: ng.translate.ITranslationTable = {
            ...
            START_FROM_ROW: 'Importeer vanaf rij',
            START_FROM_ROW_HELP: 'De data moet één rij met titels bevatten. Indien er meerdere rijen zijn, geef aan welke de onderste rij met titels is.',
            ...
            UPLOAD_HELP: 'Sleep een bestand naar het tekstvak hieronder. Een andere optie is om de data via het klembord in het tekstvak te plakken. (Het wordt aangeraden om een bestand van max. ~10MB met een maximum van 1000 regels te uploaden).',
            ...
            LAYER_TITLE_HELP: 'Titel van de kaartlaag die je wilt maken van je data, bijv. "Voetbalclubs" of "Verkiezingsuitslag")',
            ...
            TOOLTIP_HELP: 'De tooltip is het tekstveldje dat verschijnt als je je muis op een item op de kaart beweegt',
            CALLOUT_HELP: 'Toon of verberg de eigenschap in het rechter-menu',
            ...
            GROUP: 'Thema',
            GROUP_HELP: 'Selecteer een thema waaronder je 1 of meerdere kaartlagen wilt plaatsen (bijv. thema "Sport" voor kaartlagen "Voetbalclubs" en "Tennisclubs")',
            ...
            DELETED_PROJECT: 'Project is verwijderd',
            DELETED_GROUP: 'Thema is verwijderd',
            DELETED_LAYER: 'Kaartlaag is verwijderd',
